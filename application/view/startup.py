from application.view.newcustomer import Customer
from application.view.producthandler import ProductsHandler
from application.view.cart import Cart
from application.view.persons import Person
from application.view.company import Company
from application.view.packages import Package
