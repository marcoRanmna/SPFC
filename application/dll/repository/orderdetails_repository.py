...
def get_specific_orderdetails(idOrderdetails=None, product_number=None, quantityprdered=None, price=None, Orders_idOrders=None,):
    d = {idOrderdetails:Orderdetail.idOrderdetails, product_number:Orderdetail.product_number, quantityprdered:Orderdetail.quantityordered, price:Orderdetail.price, Orders_idOrders:Orderdetail.Orders_idOrders}
